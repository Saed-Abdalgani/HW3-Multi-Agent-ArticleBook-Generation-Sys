...
- **M3 contract:** after generation, call **verify_m3_assets**; it checks `figures/graph.pdf`, `figures/image.png` (non-empty files), and `\includegraphics` targets referenced from `latex/chapters/m3_fr9_showcase.tex`.
