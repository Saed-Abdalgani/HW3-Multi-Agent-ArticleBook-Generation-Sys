...
**Authors:** Saed Abdalgani, Mohamad Shawki.

**Context:** Coursework (HW3 — multi-agent article/book generation).

For use beyond the classroom, add an explicit **SPDX** license identifier in this section and in `pyproject.toml` / repository metadata so downstream consumers know redistribution and attribution terms.