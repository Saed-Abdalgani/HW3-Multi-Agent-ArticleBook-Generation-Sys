...
def build_m5_tasks(agents: dict[str, Agent], topic: str, language: str) -> list[Task]:
    ...
    compile_ = Task(
        ...
        expected_output="Canonical multipass compile executed; journal at build/m5_crew_compile_journal.json.",
    ...
    qa = Task(
        ...
        "engine pass log under `build/m5_crew_pass*_*.log` for errors. Write `build/m5_qa_report.md` "
